        ...
        return Response(
            {
                ...
                "bio": profile.bio,
                "avatar": avatar_url,
                "is_online": profile.is_online_effective(),
        ...
        return Response(
            {
                ...
                "is_online": target_profile.is_online_effective(),
    ...
    def get(self, request):
        ...
        for u in users:
            ...
            results.append({
                ...
                "is_online": prof.is_online_effective(),
        ...
        for r in received_requests:
            ...
            received_data.append({
                ...
                "user": {
                    ...
                    "is_online": sender_prof.is_online_effective(),
                },
        ...
        for s in sent_requests:
            ...
            sent_data.append({
                ...
                "user": {
                    ...
                    "is_online": receiver_prof.is_online_effective(),
                },
